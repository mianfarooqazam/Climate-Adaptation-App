...
const PAD_H = 24;
const AVAIL_W = SCENE_W - PAD_H * 2 - THERMO_W;
...
const styles = StyleSheet.create({
  ...
  learnSunGlow1: { position: 'absolute', width: 68, height: 68, borderRadius: 34, backgroundColor: 'rgba(255,235,59,0.35)' },
  learnSunEmoji: { fontSize: 46 },
  learnRayContainer: {
    position: 'relative',
    width: 220,
    height: 165,
