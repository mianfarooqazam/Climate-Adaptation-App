...
const LEVEL_TITLE_KEY: Record<string, 'roofShield' | 'hotWalls' | 'fullProtection' | 'windowLayers' | 'learnLayersTitle' | 'addRightWindowTitle'> = {
  'w1-l1': 'roofShield',
  'w1-l2': 'hotWalls',
...
const WORLD_TITLE_KEY: Record<string, 'w1Title' | 'w2Title' | 'w3Title' | 'w4Title' | 'w5Title'> = {
  w1: 'w1Title',
  w5: 'w5Title',
  w2: 'w2Title',
  w3: 'w3Title',
...
const WORLD_SUBTITLE_KEY: Record<string, 'w1Subtitle' | 'w2Subtitle' | 'w3Subtitle' | 'w4Subtitle' | 'w5Subtitle'> = {
  w1: 'w1Subtitle',
  w5: 'w5Subtitle',
  w2: 'w2Subtitle',
  w3: 'w3Subtitle',
...
const WORLD_DESC_KEY: Record<string, 'w1Description' | 'w2Description' | 'w3Description' | 'w4Description' | 'w5Description'> = {
  w1: 'w1Description',
  w5: 'w5Description',
  w2: 'w2Description',
  w3: 'w3Description',
