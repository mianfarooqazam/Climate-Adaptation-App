...
const TYPE_LABEL_EN: Record<MiniGameType, string> = {
  ...
  'landscaping-game': 'Landscaping',
};

// Maps for insulation world translated titles & descriptions
const LEVEL_TITLE_KEY: Record<string, 'roofShield' | 'hotWalls' | 'fullProtection' | 'windowLayers' | 'learnLayersTitle' | 'addRightWindowTitle' | 'landscapingLevel1' | 'landscapingLevel2'> = {
  'w1-l1': 'roofShield',
  'w1-l2': 'hotWalls',
  'w1-l3': 'fullProtection',
  'w5-l1': 'learnLayersTitle',
  'w5-l2': 'addRightWindowTitle',
  'w6-l1': 'landscapingLevel1',
  'w6-l2': 'landscapingLevel2',
};
const WORLD_TITLE_KEY: Record<string, 'w1Title' | 'w2Title' | 'w3Title' | 'w4Title' | 'w5Title' | 'w6Title'> = {
  w1: 'w1Title',
  w5: 'w5Title',
  w2: 'w2Title',
  w3: 'w3Title',
...
const WORLD_SUBTITLE_KEY: Record<string, 'w1Subtitle' | 'w2Subtitle' | 'w3Subtitle' | 'w4Subtitle' | 'w5Subtitle' | 'w6Subtitle'> = {
  w1: 'w1Subtitle',
  w5: 'w5Subtitle',
  w2: 'w2Subtitle',
  w3: 'w3Subtitle',
...
const WORLD_DESC_KEY: Record<string, 'w1Description' | 'w2Description' | 'w3Description' | 'w4Description' | 'w5Description' | 'w6Description'> = {
  w1: 'w1Description',
  w5: 'w5Description',
  w2: 'w2Description',
  w3: 'w3Description',
            ...
            >
              ...
              <View style={styles.levelInfo}>
                ...
                <Text style={styles.levelType}>
                  {level.type === 'insulation-game' ? t('typeInsulation') : level.type === 'windows-game' ? t('typeWindows') : level.type === 'landscaping-game' ? t('typeLandscaping') : TYPE_LABEL_EN[level.type]} {'  '}
