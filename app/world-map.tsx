...
function WorldCard({
  ...
  const worldTitleKeyMap: Record<string, 'w1Title' | 'w2Title' | 'w3Title' | 'w4Title' | 'w5Title' | 'w6Title'> = {
    w1: 'w1Title',
    w5: 'w5Title',
    w2: 'w2Title',
    w3: 'w3Title',
  ...
  const worldSubtitleKeyMap: Record<string, 'w1Subtitle' | 'w2Subtitle' | 'w3Subtitle' | 'w4Subtitle' | 'w5Subtitle' | 'w6Subtitle'> = {
    w1: 'w1Subtitle',
    w5: 'w5Subtitle',
    w2: 'w2Subtitle',
    w3: 'w3Subtitle',
