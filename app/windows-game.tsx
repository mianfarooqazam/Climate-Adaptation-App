...
const styles = StyleSheet.create({
  ...
  layerBtnActive: { backgroundColor: '#FFFFFF', borderColor: '#E53935' },
  layerBtnActive2: { backgroundColor: '#FFFFFF', borderColor: '#F9A825' },
  layerBtnActive3: { backgroundColor: '#FFFFFF', borderColor: '#00838F' },
